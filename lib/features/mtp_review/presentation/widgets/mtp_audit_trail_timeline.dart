...
class MtpAuditTrailTimeline extends StatelessWidget {
  final List<MtpAuditLogModel> auditTrail;

  const MtpAuditTrailTimeline({super.key, required this.auditTrail});
  ...
  Widget _buildTimelineRow(MtpAuditLogModel log, bool isLast) {
